...
for i in range(no_of_disks):
    j.do.execute('qemu-img create -f raw openvstorage+tcp:10.103.1.22:26203/archive/disk%s %sG'%(i, disk_size))
    j.do.execute("tap-ctl create -a openvstorage+tcp:10.103.1.22:26203/archive/disk%s"%i)
