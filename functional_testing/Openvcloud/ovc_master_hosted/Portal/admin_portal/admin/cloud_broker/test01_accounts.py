...
from ...page_elements_xpath.cloud_broker import accounts


class AccountsTests(BaseTest):

    def test01_create_search_edit_disable_enable_delete_account(self):
        """ PRTL-000
        *Test case to make sure that create/search/edit/disable/enable/delete
         actions on accounts are working as expected*
        ...
        **Test Scenario:**
        ...
        #. edit account parameters and verify it should succeed
        #. delete account and verify it should succeed
        """
