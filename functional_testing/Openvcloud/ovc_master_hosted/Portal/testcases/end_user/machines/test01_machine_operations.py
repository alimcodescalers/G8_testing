...
class Write(Framework):
    ...
    def setUp(self):
        ...
        self.Login.Login()
        self.EUMachines._end_user_create_virtual_machine(machine_name=self.machine_name)
        self.EUMachines._end_user_get_machine_page(machine_name=self.machine_name)
        self.EUMachines._end_user_get_machine_info(machine_name=self.machine_name)
    ...
    def test01_machine_stop_start_reboot_reset_pause_resume(self):
        ...
        **Test Scenario:**
        ...
        self.EUMachines._end_user_wait_machine("RUNNING")
        self.EUMachines._end_user_verify_machine_elements("RUNNING")

        self.lg('stop machine, should succeed')
        self.click("machine_stop")
        time.sleep(10)
        self.EUMachines._end_user_wait_machine("HALTED")
        self.click("console_tab")
        self.EUMachines._end_user_verify_machine_console("HALTED")
        self.click("actions_tab")
        self.EUMachines._end_user_wait_machine("HALTED")
        self.EUMachines._end_user_verify_machine_elements("HALTED")
        ...
        self.EUMachines._end_user_wait_machine("RUNNING")
        self.click("console_tab")
        self.EUMachines._end_user_verify_machine_console("RUNNING")
        self.click("actions_tab")
        self.EUMachines._end_user_wait_machine("RUNNING")
        self.EUMachines._end_user_verify_machine_elements("RUNNING")
        self.click("refresh_button")
        ...
        time.sleep(10)
        self.click("console_tab")
        self.EUMachines._end_user_verify_machine_console("PAUSED")
        self.click("actions_tab")
        self.EUMachines._end_user_wait_machine("PAUSED")
        self.EUMachines._end_user_verify_machine_elements("PAUSED")
        self.click("refresh_button")
        self.EUMachines._end_user_wait_machine("PAUSED")
        self.EUMachines._end_user_verify_machine_elements("PAUSED")
