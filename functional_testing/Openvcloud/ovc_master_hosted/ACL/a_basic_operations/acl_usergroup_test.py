...
class user_groups(ACLACCOUNT):
    def test_1_user_group(self):
        ...
        **Test Scenario:**
        ...
        try:
           cloudspaceId=self.user1_api.cloudapi.cloudspaces.create(accountId=self.account_id,location='du-conv-2',name=self.user1,access=self.user1)
    ...
    def test_2_user_group(self):
        ...
        **Test Scenario:**
        ...
        try:
            cloudspaceId=self.user1_api.cloudbroker.cloudspace.create(accountId=self.account_id,location='du-conv-2',name=self.user1,access=self.user1)
    ...
    def test_3_user_group(self):
        ...
        **Test Scenario:**
        ...
        cloudspaceId = self.cloudapi_cloudspace_create( account_id=accountId,location=location,access=self.user2,api=self.user2_api)
