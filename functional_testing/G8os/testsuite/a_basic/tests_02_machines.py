...
class Machinetests(BaseTest):
    ...
    def test001_create_destroy_list_kvm(self):
        ...
        **Test Scenario:**
        ...
        rs=self.client.bash('chmod 777 /var/cache && mkdir /var/cache/Images')
        result=rs.get()
    ...
    def test002_create_list_delete_containers(self):
        ...
        **Test Scenario:**
        ...
        C1 = self.client.container.create(root_url='https://hub.gig.tech/maxux/ubuntu1604.flist',storage='ardb://hub.gig.tech:16379')
    ...
    def test003_deal_with_container_client(self):
        ...
        **Test Scenario:**
        ...
        #. Create a new container (C1), should succeed
        #. Get client
        #. use client  to create  folder using system
        #. use client to check folder is exist,delete it using bash
        #. Destroy C1, should succeed
        ...
        self.lg('Create folder using system ,should succeed')
        folder = self.rand_str()
        C1_client.system('mkdir {}'.format(folder))
        time.sleep(0.5)

        self.lg('Check that the folder is created using bash')
