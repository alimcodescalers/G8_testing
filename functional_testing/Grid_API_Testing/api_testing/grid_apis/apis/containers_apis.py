...
class ContainersAPI(GridAPIBase):
    ...
    def post_containers_containerid_filesystem(self, node_id, container_id, body):
        method = 'post'
    ...
    def get_containers_containerid_filesystem(self, node_id, container_id):
        method = 'get'
        api = ['nodes', node_id, 'containers', container_id, 'filesystem']
        return self.request_api(method=method,
                                api=api)

    def delete_containers_containerid_filesystem(self, node_id, container_id):
        method = 'delete'
        api = ['nodes', node_id, 'containers', container_id, 'filesystem']
        return self.request_api(method=method,
                                api=api)
