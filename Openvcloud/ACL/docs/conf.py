# -*- coding: utf-8 -*-
#
# OpenVCloud Testsuite documentation build configuration file, created by
# sphinx-quickstart on Wed Jan 20 10:49:57 2016.
#
...
MOCK_MODULES = ['JumpScale',
                'JumpScale.portal',
                'JumpScale.portal.portal',
                'JumpScale.portal.portal.PortalClient2',
                'JumpScale.baselib',
...
htmlhelp_basename = 'OpenVCloudTestsuitedoc'
...
latex_documents = [
    (master_doc, 'OpenVCloudTestsuite.tex', u'OpenVCloud Testsuite Documentation',
     u'CodeScalers', 'manual'),
]
