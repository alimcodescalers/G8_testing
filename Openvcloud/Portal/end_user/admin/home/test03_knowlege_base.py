...
class KnowledgeBase(BaseTest):
    ...
    def test05_technical_tutorials_forth_tab(self):
        ...
        **Test Scenario:**
        ...
        self.assertEqual(self.get_text("knowledge_base_line4_tab_text1"),
                         "passwd root")
        ...
        self.assertEqual(self.get_text("knowledge_base_line4_tab_text2"),
                         "vim /etc/ssh/sshd_config:\nPermitRootLogin yes")
        self.assertEqual(self.get_text("knowledge_base_line4_tab_line3"),
                         "Restarting ssh:")
        self.assertEqual(self.get_text("knowledge_base_line4_tab_text3"),
                         "service ssh restart")
        self.lg('%s ENDED' % self._testID)
